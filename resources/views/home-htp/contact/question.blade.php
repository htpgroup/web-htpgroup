            ...
            <div class="row">
                <div class="col-12 col-lg-4 px-3 pt-10 pt-lg-20 pb-10">
                    <ul class="list-unstyled">
                        <li class="me-4 me-lg-0 mb-4 mb-md-10 mb-lg-16"><a class="text-decoration-none text-muted h4 ps-4" href="{{route('HomePay.contactWebPay')}}">Thông tin liên hệ</a></li>
                        <li class="me-4 me-lg-0 mb-4 mb-md-10 mb-lg-16"><a class="text-decoration-none text-dark h4 ps-4 border-start border-info" href="{{route('HomePay.contactWebPay')}}">Câu hỏi thường gặp</a></li>
                    </ul>
                </div>
                <div class="col-12 col-lg-8">
                    <h3 class="mb-4 colorCustomer">Dành cho doanh nghiệp</h3>
                    <ul class="list-unstyled">
                    ...
                    <div class="text-left"><a href="{{route('HomePay.questionListWebPay')}}">Xem thêm...</a></div>
                    <h3 class="mb-4 colorCustomer">Dành cho Chủ thẻ</h3>
                    <ul class="list-unstyled">
                        <li class="py-5 border-bottom">
                            <button class="bg-transparent border-0 w-100 d-flex justify-content-between align-items-center text-start">
                                <span class="h4">Creating Content Wireframes For Responsive Design</span>
