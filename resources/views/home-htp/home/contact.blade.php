...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset_cdn('themes/finderv3/css/bootstrap/bootstrap.min.css')}}">
          ...
          <div class="row">
            <div class="col-12 col-lg-8">
              ...
              <ul class="list-unstyled">
                ...
                <li class="py-5 border-bottom">
                  <button class="bg-transparent border-0 w-100 d-flex justify-content-between align-items-center text-start">
                    <span class="h4">Design Better And Faster With Rapid Prototyping</span>
                    <svg class="flex-shrink-0" width="20" height="20" viewbox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M0.75 10C0.75 15.108 4.891 19.25 10 19.25C15.108 19.25 19.25 15.108 19.25 10C19.25 4.892 15.108 0.75 10 0.75C4.891 0.75 0.75 4.892 0.75 10Z" stroke="#838EA4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                      <path d="M6.52881 8.55774L9.99981 12.0437L13.4708 8.55774" stroke="#838EA4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                    </svg>
                ...
                <li class="py-5 border-bottom">
                  <button class="bg-transparent border-0 w-100 d-flex justify-content-between align-items-center text-start">
                    <span class="h4">Choosing The Right Prototyping Tool</span>
                    <svg class="flex-shrink-0" width="20" height="20" viewbox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M0.75 10C0.75 15.108 4.891 19.25 10 19.25C15.108 19.25 19.25 15.108 19.25 10C19.25 4.892 15.108 0.75 10 0.75C4.891 0.75 0.75 4.892 0.75 10Z" stroke="#838EA4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                      <path d="M6.52881 8.55774L9.99981 12.0437L13.4708 8.55774" stroke="#838EA4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                    </svg>
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 col-lg-4 px-3 pt-10 pt-lg-20 pb-10">
              <ul class="list-unstyled">
                <li class="me-4 me-lg-0 mb-4 mb-md-10 mb-lg-16"><a class="text-decoration-none text-muted h4 ps-4" href="{{route('HomePay.homeWebPay')}}">Thông tin liên hệ</a></li>
                <li class="me-4 me-lg-0 mb-4 mb-md-10 mb-lg-16"><a class="text-decoration-none text-dark h4 ps-4 border-start border-info" href="{{route('HomePay.homeWebPay')}}">Câu hỏi thường gặp</a></li>
              </ul>
            </div>
            <div class="col-12 col-lg-8">
              <h3 class="mb-4">Dành cho doanh nghiệp</h3>
              <ul class="list-unstyled">
                <li class="py-5 border-bottom">
                  <button class="bg-transparent border-0 w-100 d-flex justify-content-between align-items-center text-start">
                    <span class="h4">Creating Content Wireframes For Responsive Design</span>
              ...
              <div class="text-left"><a href="{{route('HomePay.homeWebPay')}}">Xem thêm...</a></div>
              <h3 class="mb-4">Dành cho Chủ thẻ</h3>
              <ul class="list-unstyled">
                <li class="py-5 border-bottom">
                  <button class="bg-transparent border-0 w-100 d-flex justify-content-between align-items-center text-start">
      ...
      <section class="position-relative py-20">
        <div class="container">
          <div class="row">
            <div class="col-12 col-lg-4 px-3 pt-10 pt-lg-20 pb-10">
              <ul class="list-unstyled">
                <li class="me-4 me-lg-0 mb-4 mb-md-10 mb-lg-16"><a class="text-decoration-none text-dark h4 ps-4 border-start border-info" href="{{route('HomePay.homeWebPay')}}">Thông tin liên hệ</a></li>
                <li class="me-4 me-lg-0 mb-4 mb-md-10 mb-lg-16"><a class="text-decoration-none text-muted h4 ps-4" href="{{route('HomePay.homeWebPay')}}">Câu hỏi thường gặp</a></li>
              </ul>
            </div>
            <div class="col-12 col-lg-8">
              <div class="max-w-3xl mx-auto mb-12 mb-lg-20 text-center">
                <h2 class="mt-8 mb-10">Liên hệ ngay để được hỗ trợ</h2>
              </div>
              <div class="row align-items-center">
                <div>
                  <img class="img-fluid lazyload mx-auto mb-6 rounded" style="width: 640px; object-fit: cover;" src="https://res.cloudinary.com/dumntyicq/image/upload/v1647922765/OmiPay/Frame_6493_gu49ek.png')}}" alt="">
                </div>
              </div>
              <div class="row align-items-center">
                <h2 class="mt-8 mb-14 px-lg-3">Hoặc để lại phản hồi</h2>
                <form action="#">
                  <div class="position-relative mb-6">
                    <input class="form-control" type="text" placeholder="Daniel">
                    <span class="position-absolute start-0 top-0 ms-3 mt-n2 px-1 bg-white text-muted small">Name</span>
                  </div>
                  <div class="position-relative mb-6">
                    <input class="form-control" type="email" placeholder="e.g hello@shuffle.dev">
                    <span class="position-absolute start-0 top-0 ms-3 mt-n2 px-1 bg-white text-muted small">Your Địa chỉ email</span>
                  </div>
                  <div class="position-relative mb-6">
                    <textarea class="form-control" style="resize: none;" type="message" cols="20" rows="8" placeholder="Message..."></textarea>
                    <span class="position-absolute start-0 top-0 ms-3 mt-n2 px-1 bg-white text-muted small">Your message</span>
                  </div>
