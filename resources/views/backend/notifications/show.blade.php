...
<div class="card">
    <div class="card-body">
        <x-backend.section-header>
            ...
            <x-slot name="toolbar">
                <a href="{{ route("backend.$module_name.index") }}" class="btn btn-secondary mt-1 btn-sm" data-toggle="tooltip" title="{{ __(ucwords($module_name)) }} List"><i class="fas fa-list"></i> Danh sách</a>
            </x-slot>
        </x-backend.section-header>
